 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_CAPS,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_SLSH,
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_HOME,      KC_END,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_NO,  KC_GRV,
                        MO(_LOWER), KC_LALT, KC_LGUI, KC_SPC,       MO(_RAISE), KC_RGUI, KC_NO, KC_RSFT
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
